# GitHub with Container Apps, public networking and GitHub App authentication

This example deploys GitHub Runners to Azure Container Apps using public networking and GitHub App authentication. Use this pattern when private networking is not required.
