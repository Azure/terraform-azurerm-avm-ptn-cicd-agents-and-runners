# GitHub with Container Instances, private networking and PAT authentication

This example deploys GitHub Runners to Azure Container Instances using private networking and Personal Access Token (PAT) authentication.

> **Note:** PAT authentication is provided for backwards compatibility. For new deployments prefer GitHub App authentication — see the `github_aci_private_app_auth` example.
