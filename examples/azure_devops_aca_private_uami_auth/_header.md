# Azure DevOps with Container Apps, private networking and UAMI authentication

This example deploys Azure DevOps Agents to Azure Container Apps using private networking and User Assigned Managed Identity (UAMI) authentication. This is the recommended starting point for new deployments.
