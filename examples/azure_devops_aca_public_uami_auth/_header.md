# Azure DevOps with Container Apps, public networking and UAMI authentication

This example deploys Azure DevOps Agents to Azure Container Apps using public networking and User Assigned Managed Identity (UAMI) authentication. Use this pattern when private networking is not required.
