output "container_app_environment_primary_name" {
  value = module.github_runners_primary.name
}

output "container_app_environment_primary_resource_id" {
  value = module.github_runners_primary.resource_id
}

output "container_app_environment_secondary_name" {
  value = module.github_runners_secondary.name
}

output "container_app_environment_secondary_resource_id" {
  value = module.github_runners_secondary.resource_id
}

output "container_app_job_primary_name" {
  value = module.github_runners_primary.job_name
}

output "container_app_job_primary_resource_id" {
  value = module.github_runners_primary.job_resource_id
}

output "container_app_job_secondary_name" {
  value = module.github_runners_secondary.job_name
}

output "container_app_job_secondary_resource_id" {
  value = module.github_runners_secondary.job_resource_id
}
