# ========================================
# Azure DevOps Container Instance with PAT - Backwards Compatibility Example
# ========================================
...
locals {
  tags = {
    scenario = "azure_devops_aci_private_pat_auth"
  }
}
...
resource "azuredevops_project" "this" {
  name = "pat-aci-agents-${random_string.name.result}"
}

resource "azuredevops_agent_pool" "this" {
  name           = "ContainerInstance-PAT-${random_string.name.result}"
...
locals {
  ...
  repository_name = "agents-pat-aci-repo"
}
...
resource "azuredevops_build_definition" "this" {
  project_id = azuredevops_project.this.id
  name       = "Container Instance PAT Build"
...
# This is the module call with Container Instance configuration
