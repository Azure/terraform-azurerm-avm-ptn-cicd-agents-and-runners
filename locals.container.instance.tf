...
locals {
  ...
  container_instance_environment_variables_azure_devops = local.version_control_system_authentication_method == "uami" ? [
    {
      name  = "AZP_URL"
  ...
  container_instance_environment_variables_github = local.version_control_system_authentication_method == "pat" ? [
    {
      name  = "GH_RUNNER_NAME"
      value = "${local.version_control_system_agent_name_prefix}-%s"
    },
...
locals {
  ...
  container_instance_sensitive_environment_variables_azure_devops = local.version_control_system_authentication_method == "uami" ? [] : [
    {
      name  = "AZP_TOKEN"
  ...
  container_instance_sensitive_environment_variables_github = local.version_control_system_authentication_method == "pat" ? [
    {
    ...
    {
      name  = "GH_RUNNER_APP_PRIVATE_KEY"
